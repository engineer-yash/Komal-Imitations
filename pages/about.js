...
export default function About() {
  ...
  return (
    <Layout>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-primary/10 via-secondary to-primary/5 py-20 overflow-hidden">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.1 }}
          className="absolute top-0 right-0 w-96 h-96 border-4 border-primary rounded-full"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.05 }}
          className="absolute bottom-0 left-0 w-64 h-64 border-4 border-primary rounded-full"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold font-playfair mb-6 text-primary">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-br from-secondary via-white to-secondary p-12 md:p-16 rounded-3xl mb-20"
        >
          <h2 className="text-4xl font-semibold font-playfair text-center mb-16">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 font-playfair">Quality Craftsmanship</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 font-playfair">Affordable Luxury</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 font-playfair">Customer First</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="mb-20">
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-4xl font-semibold font-playfair text-center mb-12"
          >
            Why Shop With Us
          </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div
                ...
                className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300"
              >
                <div className="text-4xl flex-shrink-0">{item.icon}</div>
                <div>
                  <h3 className="text-xl font-semibold mb-2 font-playfair">{item.title}</h3>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-primary to-[#B5952F] text-white rounded-3xl p-12 md:p-16 text-center"
        >
          <h2 className="text-4xl md:text-5xl font-semibold font-playfair mb-6">Visit Our Store</h2>
          <p className="text-xl mb-8 opacity-90">Experience our exquisite collection in person</p>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            <p className="text-2xl font-semibold mb-4">Komal Jewellers</p>
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-block bg-white text-primary hover:bg-gray-100 rounded-full px-10 py-4 font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Get Directions 📍
            </a>
          </div>
